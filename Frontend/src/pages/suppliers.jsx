...
const Suppliers = () => {
    ...
    const storename = profile?.storename; // Declare storename at the top
    ...
    // Fetch suppliers and orders/new purchases
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                // Fetch suppliers
                const suppliersResponse = await fetch(`http://localhost:3000/${storename}/suppliers`);
                const suppliersData = await suppliersResponse.json();
                if (suppliersResponse.ok && suppliersData.success) {
                    setSuppliers(suppliersData.data);
                } else {
                    console.error('Failed to fetch suppliers:', suppliersData.message);
                }
                ...
                if (ordersResponse.ok && ordersData.success) {
                    ...
                    console.error('Failed to fetch purchase orders:', ordersData.message);
                }
